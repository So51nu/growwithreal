...
const PROPERTY_TYPE_CATEGORY_VALUES = new Set(["residential", "commercial"]);
const PROPERTY_STATUS_CATEGORY_VALUES = new Set([
  "under construction",
  "ready to move",
]);

function getCategoryListingHref(category) {
  ...
  if (PROPERTY_TYPE_CATEGORY_VALUES.has(value)) {
    params.set("property_type", value);
    params.set("propertyType", value);
  }

  if (PROPERTY_STATUS_CATEGORY_VALUES.has(value)) {
    params.set("property_status", value);
    params.set("propertyStatus", value);
  }

  const queryString = params.toString();
  return `/property-listing${queryString ? `?${queryString}` : ""}`;
}
...
export default function Hero({ onSearch = () => {}, projects = [] }) {
  ...
  useEffect(() => {
    const handleFixedSearch = () => {
      ...
      setIsSearchFixed(hasScrolled && !isMobileView);
      setIsMobileSearchHidden(hasScrolled && isMobileView);

      if (hasScrolled && isMobileView) {
        setShowSuggestions(false);
        setShowCityDropdown(false);
      }
    };
  ...
  const handleCategoryClick = (category) => {
    ...
    const isPropertyStatus = PROPERTY_STATUS_CATEGORY_VALUES.has(categoryValue);
    ...
    onSearch({
      ...
      city: selectedCity,
      location: "",
      propertyType: isPropertyStatus ? "" : categoryValue,
      propertyStatus: isPropertyStatus ? categoryValue : "",
      bedrooms: "",
      bathrooms: "",
      amenities: [],
      sortBy: "Newest",
    ...
    router.push(getCategoryListingHref(category));
  };
  ...
  return (
    <>
      <section
        className={`page-title home01 hero-slider-wrap ${
          showCityDropdown ? "hero-city-dropdown-open" : ""
        }`}
      >
        <div className="hero-bg-slider">
          {HERO_SLIDES.map((slide, index) => (
              ...
              <div className="content-inner">
                ...
                <div
                  className={`hero-search-only-wrap ${
                    ...
                    isMobileSearchHidden ? "hero-search-mobile-hidden" : ""
                  }`}
                >
                  <form
                    onSubmit={handleSearch}
        ...
        <style jsx global>{`
          ...
          /* =========================================================
             Mobile final formatting + city dropdown overlap fix
             ========================================================= */
          @media (max-width: 991px) {
            .hero-slider-wrap,
            .page-title.home01.hero-slider-wrap {
            ...
            .hero-search-fieldset {
              ...
              box-shadow: 0 8px 18px rgba(6, 44, 71, 0.18) !important;
              overflow: visible !important;
              box-sizing: border-box !important;
            ...
            .hero-city-menu {
              ...
              z-index: 2147483647 !important;
              background: #ffffff !important;
              box-shadow: 0 16px 38px rgba(6, 44, 71, 0.24) !important;
            }
            ...
            .hero-city-dropdown-open .hero-location-chip-row,
            .hero-city-dropdown-open .hero-slide-dots {
              display: none !important;
            }

            .hero-city-dropdown-open {
              padding-bottom: 226px !important;
            }

            .hero-search-only-wrap.hero-search-mobile-hidden,
            .hero-search-only-wrap.hero-search-fixed-active {
              display: none !important;
          ...
          /* =========================================================
             FINAL FIX: MOBILE CITY DROPDOWN SAME AS WEB
             Keeps dropdown fully visible above next section.
             ========================================================= */
          @media (max-width: 991px) {
            .hero-slider-wrap,
            .page-title.home01.hero-slider-wrap,
            ...
            .page-title.home01.hero-slider-wrap.hero-city-dropdown-open {
              overflow: visible !important;
              z-index: 2147482000 !important;
              padding-bottom: 224px !important;
            }

            .hero-city-dropdown-open .hero-bg-slider,
            .hero-city-dropdown-open .hero-bg-slide,
            .hero-city-dropdown-open .hero-overlay {
              overflow: hidden !important;
            }

            .hero-city-dropdown-open .hero-search-only-wrap,
            .hero-city-dropdown-open .hero-search-only-form,
            .hero-city-dropdown-open .hero-search-fieldset {
              position: relative !important;
              overflow: visible !important;
            ...
            .hero-city-dropdown-open .hero-search-fieldset {
              box-shadow: 0 12px 26px rgba(6, 44, 71, 0.24) !important;
            }

            .hero-city-dropdown-open .hero-city-select {
              position: static !important;
              z-index: auto !important;
            }

            .hero-city-dropdown-open .hero-city-menu {
              ...
              padding: 6px !important;
              box-shadow: 0 18px 45px rgba(6, 44, 71, 0.26) !important;
              z-index: 2147483647 !important;
            }

            .hero-city-dropdown-open .hero-city-option {
              display: flex !important;
              align-items: center !important;
              width: 100% !important;
            ...
            .hero-city-dropdown-open .hero-city-option:hover,
            .hero-city-dropdown-open .hero-city-option.active {
          ...
          /* =========================================================
             FINAL FIX: MOBILE CATEGORY START ALIGNMENT
             Residential card will start from same left position as
             city chips/search content on mobile. Desktop unchanged.
             ========================================================= */
          @media (max-width: 991px) {
            .mobile-category-scroll {
            ...
            .mobile-category-card:first-child {
              margin-left: 0 !important;
            }
          }
