...
// //         @media (max-width: 575px) {
// //           .tf-layout-mobile-md.growl-property-grid {
// //             display: grid !important;
...
// //           .growl-property-grid > div:last-child,
// //           .growl-property-grid-item:last-child {
// //             margin-bottom: 0 !important;
// //           }
...
// //               <div className="tf-layout-mobile-md md-col-2 lg-col-3 growl-property-grid">
// //                 {filteredProperties.slice(0, 9).map((property) => (
// //                   <div className="growl-property-grid-item" key={property.id}>
// //                     {renderCard(property)}
// //                   </div>
// //                 ))}
// //               </div>
...
//     property.gallery.forEach(addImage);
//   }

//   if (Array.isArray(property.property_images)) {
//     property.property_images.forEach(addImage);
//   }

//   if (Array.isArray(property.photos)) {
//     property.photos.forEach(addImage);
//   }

//   return imageList.length > 0 ? imageList : ["/images/home/house-1.jpg"];
// }
...
//       height="22"
//       viewBox="0 0 24 24"
//       fill={active ? "#173C5B" : "none"}
//       xmlns="http://www.w3.org/2000/svg"
//       aria-hidden="true"
//     >
//       <path
//         d="M20.84 4.61C20.3292 4.099 19.7228 3.69365 19.0554 3.41708C18.3879 3.14052 17.6725 2.99817 16.95 2.99817C16.2275 2.99817 15.5121 3.14052 14.8446 3.41708C14.1772 3.69365 13.5708 4.099 13.06 4.61L12 5.67L10.94 4.61C9.9083 3.57831 8.50903 2.99871 7.05 2.99871C5.59096 2.99871 4.19169 3.57831 3.16 4.61C2.1283 5.6417 1.54871 7.04097 1.54871 8.5C1.54871 9.95904 2.1283 11.3583 3.16 12.39L12 21.23L20.84 12.39C21.351 11.8792 21.7563 11.2728 22.0329 10.6054C22.3095 9.9379 22.4518 9.22249 22.4518 8.5C22.4518 7.77752 22.3095 7.06211 22.0329 6.39464C21.7563 5.72718 21.351 5.12076 20.84 4.61Z"
//         stroke={active ? "#173C5B" : "#ffffff"}
//         strokeWidth="2"
//         strokeLinecap="round"
//         strokeLinejoin="round"
//       />
...
//   const [touchStartXByProperty, setTouchStartXByProperty] = useState({});
...
//         title: getPropertyTitle(property),
//         imageSrc: extractImage(property),
//         imageSlides: extractPropertyImages(property),
//         seller_phone: extractSellerPhone(property),
//         configuration_text: extractConfigurations(property),
//         is_favorite: property.is_favorite || favoriteIds.includes(property.id),
//         is_liked: likedIds.includes(property.id),
...
//   const setPropertyImageIndex = (propertyId, index) => {
//     setImageIndexByProperty((prev) => ({
//       ...prev,
//       [propertyId]: index,
//     }));
//   };

//   const goToPreviousImage = (event, propertyId, totalImages) => {
//     event.preventDefault();
...
//   const goToNextImage = (event, propertyId, totalImages) => {
//     event.preventDefault();
//     event.stopPropagation();
...
//   const handleSliderTouchStart = (propertyId, event) => {
//     setTouchStartXByProperty((prev) => ({
//       ...prev,
//       [propertyId]: event.touches?.[0]?.clientX || 0,
//     }));
//   };

//   const handleSliderTouchEnd = (propertyId, totalImages, event) => {
//     if (totalImages <= 1) return;

//     const startX = touchStartXByProperty[propertyId];
...
//     const detailHref = getPropertyDetailHref(property);
//     const imageSlides =
//       Array.isArray(property.imageSlides) && property.imageSlides.length > 0
//         ? property.imageSlides
//         : [property.imageSrc || "/images/home/house-1.jpg"];
//     const activeImageIndex =
//       imageIndexByProperty[property.id] >= 0 &&
//       imageIndexByProperty[property.id] < imageSlides.length
//         ? imageIndexByProperty[property.id]
//         : 0;
...
//       <div className="box-house hover-img growl-property-card">
//         <div
//           className="image-wrap growl-property-image-wrap"
//           onTouchStart={(event) =>
//             handleSliderTouchStart(property.id, event)
//           }
//           onTouchEnd={(event) =>
//             handleSliderTouchEnd(property.id, imageSlides.length, event)
//           }
//         >
//           <div className="growl-property-slider">
//             <div
//               className="growl-property-slider-track"
//               style={{
//                 transform: `translateX(-${activeImageIndex * 100}%)`,
//               }}
//             >
//               {imageSlides.map((imageUrl, imageIndex) => (
//                 <Link
//                   href={detailHref}
//                   onClick={(event) =>
//                     handleProtectedDetailClick(event, property)
//                   }
//                   className="growl-property-slide"
//                   key={`${property.id}-image-${imageIndex}-${imageUrl}`}
//                 >
//                   <Image
//                     className="lazyload growl-property-image"
...
//                       imageIndex + 1
//                     }`}
//                     src={imageUrl || "/images/home/house-1.jpg"}
//                     width={600}
//                     height={401}
...
//               <button
//                 type="button"
//                 className="growl-slider-arrow growl-slider-arrow-prev"
//                 onClick={(event) =>
//                   goToPreviousImage(event, property.id, imageSlides.length)
//                 }
...
//               <button
//                 type="button"
//                 className="growl-slider-arrow growl-slider-arrow-next"
//                 onClick={(event) =>
//                   goToNextImage(event, property.id, imageSlides.length)
//                 }
...
//               <div className="growl-slider-dots" aria-label="Property images">
//                 {imageSlides.map((_, imageIndex) => (
//                   <button
//                     type="button"
//                     key={`${property.id}-dot-${imageIndex}`}
//                     className={`growl-slider-dot ${
//                       activeImageIndex === imageIndex ? "active" : ""
//                     }`}
//                     onClick={(event) => {
//                       event.preventDefault();
//                       event.stopPropagation();
//                       setPropertyImageIndex(property.id, imageIndex);
//                     }}
...
//         .growl-slider-arrow:hover {
//           background: rgba(17, 24, 39, 0.88);
//         }

//         .growl-slider-arrow-prev {
//           left: 14px;
//         }

//         .growl-slider-arrow-next {
//           right: 14px;
//         }

//         .growl-property-image-wrap:hover .growl-slider-arrow {
//           opacity: 1;
//           visibility: visible;
//         }
...
//           border: 1px solid #173C5B !important;
//           background: #ffffff !important;
//           text-decoration: none !important;
//           min-height: 40px;
//           padding: 10px 14px !important;
...
//           .growl-listing-section {
//               padding-top: 18px !important;
//             }

//             .growl-listing-section .heading-section {
//               margin-top: 0 !important;
//               margin-bottom: 24px !important;
//             }

//             .growl-listing-section .heading-section .title {
//               margin-top: 0 !important;
//               margin-bottom: 8px !important;
//               line-height: 1.15 !important;
//             }

//             .growl-listing-section .heading-section .text-1 {
...
//       <section className="section-listing tf-spacing-1 growl-listing-section">
//         <div className="tf-container">
//           <div className="row">
//             <div className="col-12">
//               <div className="heading-section text-center">
