...
//     box-shadow:
//       0 0 0 4px rgba(255, 122, 26, 0.13),
    ...
    <section id="loan-calculator" className="home-loan-calculator-section">
      ...
      <style jsx global>{`
        ...
        .calculator-card {
          ...
          box-shadow: 0 14px 38px rgba(6, 44, 71, 0.1);
        }
        ...
        .calculator-grid {
          display: grid;
          grid-template-columns: minmax(0, 1fr) minmax(385px, 0.86fr);
          gap: 14px;
          align-items: stretch;
        }
        ...
        .range-head {
          display: grid;
          grid-template-columns: minmax(110px, 0.55fr) minmax(180px, 0.45fr);
          align-items: center;
          gap: 10px;
          margin-bottom: 6px;
        }
