...
//         #modalLogin .custom-role-select,
//         #modalLogin .custom-country-select {
//           position: relative;
//           width: 100%;
//           z-index: 50;
//         }
...
//         #modalLogin .custom-role-button,
//         #modalLogin .custom-country-button {
//           width: 100%;
//           height: 42px;
//           border: 1px solid #d1d5db;
//           border-radius: 11px;
...
//         #modalLogin .custom-role-button.active,
//         #modalLogin .custom-country-button.active {
//           border-color: #f28c52;
//           box-shadow: 0 0 0 3px rgba(242, 140, 82, 0.16);
//         }

//         #modalLogin .custom-role-arrow,
//         #modalLogin .custom-country-arrow {
//           font-size: 13px;
//           line-height: 1;
//           color: #111827;
//           transition: transform 0.2s ease;
...
//         #modalLogin .custom-role-button.active .custom-role-arrow,
//         #modalLogin .custom-country-button.active .custom-country-arrow {
//           transform: rotate(180deg);
//         }

//         #modalLogin .custom-role-menu,
//         #modalLogin .custom-country-menu {
//           position: relative;
//           top: 5px;
//           left: 0;
//           right: 0;
...
//         #modalLogin .custom-country-menu::-webkit-scrollbar {
//           width: 5px;
//         }

//         #modalLogin .custom-country-menu::-webkit-scrollbar-thumb {
//           background: #d1d5db;
//           border-radius: 20px;
//         }

//         #modalLogin .custom-role-option,
//         #modalLogin .custom-country-option {
//           width: 100%;
//           min-height: 36px;
//           border: 0;
//           background: #ffffff;
...
//         #modalLogin .custom-role-option:hover,
//         #modalLogin .custom-role-option.selected,
//         #modalLogin .custom-country-option:hover,
//         #modalLogin .custom-country-option.selected {
//           background: #f28c52;
//           color: #ffffff;
//         }

//         #modalLogin .phone-row {
//           display: grid;
...
//         #modalLogin .phone-row .custom-country-button {
//           padding: 0 10px;
//           white-space: nowrap;
//           justify-content: center;
//           gap: 6px;
  ...
  return (
    <>
      <style jsx global>{`
        ...
        #modalLogin.fade .modal-dialog,
        #modalLogin.show .modal-dialog {
