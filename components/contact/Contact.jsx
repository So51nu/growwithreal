...
// const API_URL = "https://backendgrowl.growlcityrealty.in/api/contact/submit/";
// const OFFICE_ADDRESS =
//   "1201, G Square Business Park, Sector 30A, Sanpada, Navi Mumbai - 400705";
// const MAP_QUERY = encodeURIComponent(`${OFFICE_ADDRESS}, India`);
// const MAP_SRC = `https://maps.google.com/maps?q=${MAP_QUERY}&t=&z=16&ie=UTF8&iwloc=&output=embed`;
...
// function getInterestLabel(value) {
//   return interestOptions.find((item) => item.value === value)?.label || "Buy";
// }
...
//       setPhoneError("Enter valid 10 digit mobile number starting with 6, 7, 8 or 9.");
//       return;
//     }
...
//               : "Your message has been submitted successfully. You forgot to add the email address."),
//         });
...
//                   <fieldset>
//                     <label htmlFor="email-contact">Email <small>(Optional)</small></label>
//                     <input
//                       type="email"
//                       placeholder="Email address"
//                       name="email"
...
//                               key={option.value}
//                               className={`custom-select-option ${
//                                 formData.interest === option.value ? "selected" : ""
//                               }`}
//                               onClick={() => handleInterestSelect(option.value)}
//                               role="option"
//                               aria-selected={formData.interest === option.value}
...
//                 <h3>Visit Our Office</h3>
//                 <p>
//                   <strong>Growl City Realty</strong>, {OFFICE_ADDRESS}.
//                 </p>
//               </div>
...
//                 <iframe
//                   src={MAP_SRC}
//                   title="Growl City Realty office location map"
//                   loading="lazy"
//                   referrerPolicy="no-referrer-when-downgrade"
//                   allowFullScreen
//                 />

//                 <div className="map-custom-label-card" aria-hidden="true">
//                   <strong>Growl City Realty</strong>
//                   <span>1201, G Square Business Park, Sector 30A,</span>
//                   <span>Sanpada, Navi Mumbai - 400705</span>
//                 </div>

//                 <div className="map-custom-pin-label" aria-hidden="true">
//                   Growl City Realty
//                 </div>
//               </div>
//             </div>
...
//           position: relative;
//           overflow: hidden;
//           background: var(--growl-blue-dark);
//         }
...
//           border-radius: 18px;
//           box-shadow: 0 14px 40px rgba(23, 60, 91, 0.1);
//           overflow: visible;
//         }
...
//         .custom-select-btn:focus {
//           border-color: var(--growl-blue);
//           box-shadow: 0 0 0 3px rgba(30, 77, 116, 0.13);
//         }
...
//           border: 1px solid #d1dce8;
//           border-radius: 10px;
//           box-shadow: 0 12px 30px rgba(23, 60, 91, 0.16);
//           overflow: hidden;
//           z-index: 9999;
//         }
...
//           border: none !important;
//           border-radius: 10px;
//           background: linear-gradient(135deg, var(--growl-blue-dark), var(--growl-blue)) !important;
//           color: #ffffff !important;
//           font-size: 15px;
//           font-weight: 800;
//           cursor: pointer;
//           transition: all 0.2s ease;
//           box-shadow: 0 12px 26px rgba(23, 60, 91, 0.22);
//         }

//         .contact-submit-btn:hover {
//           transform: translateY(-1px);
//           box-shadow: 0 16px 32px rgba(23, 60, 91, 0.28);
//         }
...
//           border-right: 1px solid rgba(30, 77, 116, 0.12);
//           border-bottom: 1px solid rgba(30, 77, 116, 0.12);
//           border-left: 5px solid var(--growl-yellow);
//           border-radius: 0 0 16px 0;
//           box-shadow: 0 14px 35px rgba(23, 60, 91, 0.16);
...
//           background: rgba(255, 255, 255, 0.98);
//           color: var(--growl-blue-dark);
//           border: 1px solid rgba(30, 77, 116, 0.18);
//           box-shadow: 0 10px 24px rgba(23, 60, 91, 0.18);
//           font-size: 15px;
//           line-height: 1.2;
//           font-weight: 900;
//           z-index: 4;
...
const OFFICE_ADDRESS =
  "1201, G Square Business Park, Sector 30A, Sanpada, Navi Mumbai - 400705";
const MAP_BRAND = "Growl Real Estate";
const MAP_QUERY = encodeURIComponent(`${MAP_BRAND}, ${OFFICE_ADDRESS}, India`);
const MAP_SRC = `https://maps.google.com/maps?q=${MAP_QUERY}&t=&z=16&ie=UTF8&iwloc=&output=embed`;

const interestOptions = [
  { label: " Buy New Property", value: "buy" },
];

function getInterestLabel(value) {
  return (
    interestOptions.find((item) => item.value === value)?.label ||
    " Buy New Property"
  );
}
    ...
    <>
          ...
          <div className="contact-grid">
            ...
            <div className="contact-map-card">
              <div className="map-content">
                ...
                <h3>Visit Our Office</h3>
                <p>
                  <strong>{MAP_BRAND}</strong>, {OFFICE_ADDRESS}.
                </p>
              </div>
              ...
              <div className="map-box">
                <iframe
                  src={MAP_SRC}
                  title="Growl Real Estate office location map"
                  loading="lazy"
                  referrerPolicy="no-referrer-when-downgrade"
                  allowFullScreen
                />
      ...
      <style jsx>{`
        ...
        .map-custom-label-card {
          ...
          transform: translate(-50%, -50%);
          background: rgba(255, 255, 255, 0.98);
          border: 1px solid rgba(30, 77, 116, 0.16);
          border-left: 5px solid var(--growl-yellow);
          border-radius: 14px;
          box-shadow: 0 16px 38px rgba(23, 60, 91, 0.2);
