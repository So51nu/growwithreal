    ...
    <main className="legal-page">
      <section className="legal-hero">
        <div className="legal-container">
          <span className="legal-kicker">HR Compliance</span>
          ...
          <p>
            ...
            accountability, and current career openings.
          </p>

          <div className="legal-badge-row">
            <span className="legal-badge">Equal Opportunity</span>
            <span className="legal-badge">Privacy Protection</span>
            <span className="legal-badge">Current Openings</span>
          </div>
        </div>
      </section>
        ...
        <div className="legal-container">
          ...
          <section className="openings-section">
            <div className="openings-head">
              ...
              <p>
                Explore active openings and submit your application with resume.
              </p>
            </div>
          ...
          <div className="legal-layout">
            <article className="legal-card">
              ...
              <div className="legal-bottom-nav">
                <span>Want to report misconduct or compliance concern?</span>
                <Link href="/whistle-blower-policy">View Whistleblower Policy</Link>
              </div>
            </article>
