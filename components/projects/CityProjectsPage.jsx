...
//       const subLabel = [location, developer, configuration]
//         .filter(Boolean)
...
//           .city-project-card .image-wrap img {
...
//             <p className="text-1 city-page-subtitle">
//               Showing all projects in {cityName} across all locations and
//               developers
//             </p>
//           </div>

//           <div className="city-search-box-wrap">
//             <form
//               onSubmit={handleSearch}
//               className="city-search-form"
//               ref={suggestionRef}
//             >
//               <fieldset className="city-search-fieldset">
//                 <input
//                   type="text"
//                   placeholder={`Search ${cityName} projects, location, developer...`}
//                   value={searchText}
//                   autoComplete="off"
//                   onChange={(e) => {
...
//                         >
//                           <span className="city-suggestion-label">
//                             {suggestion.label}
//                           </span>

//                           {suggestion.subLabel && (
//                             <span className="city-suggestion-sub">
//                               {suggestion.subLabel}
//                             </span>
//                           )}
//                         </button>
//                       ))
//                     ) : (
//                       <div className="city-no-suggestion">
//                         No project found for this city
//                       </div>
//                     )}
//                   </div>
//                 )}
...
//                     >
//                       <h5
//                         className="title city-project-title"
...
//                   No properties found for this city search.
//                 </p>
//               </div>
//             )}
//           </div>
...
function getProjectImages(project) {
  ...
  const pushImage = (value) => {
    const imageUrl = normalizeImageItem(value);
  ...
  [
    ...
    if (Array.isArray(collection)) {
      ...
      sortedCollection.forEach(pushImage);
    }
  });
  ...
  const uniqueImages = Array.from(
    new Map(
      imageSources
        .filter(Boolean)
        .map((imageUrl) => [String(imageUrl).trim(), imageUrl])
    ).values()
  );
...
function CityProjectImageCarousel({ project, detailHref, onViewed }) {
  ...
  return (
    ...
    >
      <ProtectedPropertyLink href={detailHref} onAllowedClick={onViewed}>
        <Image
          className="city-property-carousel-image"
          alt={getProjectTitle(project) || "Property"}
          src={images[activeIndex] || "/images/home/house-db-1.jpg"}
          width={615}
          height={405}
          style={{
            width: "100%",
      ...
      {showControls && (
        <>
          <button
            type="button"
            className="city-carousel-arrow city-carousel-arrow-prev"
          ...
          <button
            type="button"
            className="city-carousel-arrow city-carousel-arrow-next"
            onClick={goToNext}
          ...
          <div className="city-carousel-dots">
  ...
  return (
    <>
      <style jsx global>{`
        ...
        .city-property-carousel a,
        .city-property-carousel-image {
          display: block;
          width: 100%;
          height: 280px;
        }
        ...
        .city-project-card:hover .city-property-carousel-image {
        ...
        .city-carousel-arrow {
          ...
          background: rgba(30, 77, 116, 0.86);
          color: #ffffff;
          z-index: 8;
          display: flex;
          align-items: center;
        ...
        .city-carousel-arrow-prev {
          left: 14px;
        }

        .city-carousel-arrow-next {
          right: 14px;
        }
            ...
            {filteredProjects.map((project) => {
              ...
              return (
                <div className="col-md-6 col-xl-4 mb-24" key={project.id}>
                  ...
                  >
                    <div className="image-wrap" style={{ position: "relative" }}>
                      <CityProjectImageCarousel
                        project={project}
                        detailHref={detailHref}
                        onViewed={() => handleViewed(project.id)}
                      />
