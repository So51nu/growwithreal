...
//           border: 1.5px solid #0b5fa5 !important;
//           background: transparent !important;
...
//         .dark-theme .sh-root .sh-quick-link:hover .sh-quick-text { color: #0b5fa5 !important; }
  ...
  return (
    <>
      <div className="sh-root" data-open={isOpen ? "true" : "false"} ref={wrapperRef}>
        ...
        >
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M6.62 10.79C8.06 13.62 10.38 15.94 13.21 17.38L15.41 15.18C15.68 14.91 16.08 14.82 16.43 14.94C17.55 15.31 18.75 15.5 20 15.5C20.55 15.5 21 15.95 21 16.5V20C21 20.55 20.55 21 20 21C10.61 21 3 13.39 3 4C3 3.45 3.45 3 4 3H7.5C8.05 3 8.5 3.45 8.5 4C8.5 5.25 8.69 6.45 9.06 7.57C9.17 7.92 9.09 8.31 8.81 8.59L6.62 10.79Z" />
          </svg>
        </button>
      ...
      <style jsx global>{`
        ...
        .sh-trigger-btn:hover,
        .sh-root[data-open="true"] .sh-trigger-btn {
          background: #0a0a97b3 !important;
          box-shadow: -4px 0 20px rgba(255, 122, 26, 0.65) !important;
        }

        .sh-trigger-btn .sh-main-call-icon {
          display: block !important;
