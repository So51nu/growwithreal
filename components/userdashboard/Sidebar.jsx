      ...
      <div className="sidebar-menu-dashboard">
        <div className="menu-box">
          <ul className="box-menu-dashboard">
            <li className={`nav-menu-item ${isActive("/user-dashboard") ? "active" : ""}`}>
              <Link className="nav-menu-link" href="/user-dashboard">
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li className={`nav-menu-item ${isActive("/user-dashboard/my-profile") ? "active" : ""}`}>
              <Link className="nav-menu-link" href="/user-dashboard/my-profile">
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li className={`nav-menu-item ${isActive("/user-dashboard/my-save-search") ? "active" : ""}`}>
              <Link className="nav-menu-link" href="/user-dashboard/my-save-search">
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
