...
export default function Dashboard() {
  ...
  useEffect(() => {
    const loadDashboard = async () => {
      try {
        const res = await apiGet("/admindashboard/dashboard/");
        setData(res);
      } catch (error) {
        ...
        <div className="flat-counter-v2 tf-counter">
          <div className="counter-box">
            <div className="content-box">
              <div className="title-count text-variant-1">Your listing</div>
              <div className="box-count d-flex align-items-end">
                <div className="number">{data.stats.total_listing}</div>
                <span className="text">/{data.stats.remaining} remaining</span>
              </div>
            </div>
          </div>
          ...
          <div className="counter-box">
            <div className="content-box">
              <div className="title-count text-variant-1">Pending</div>
              <div className="box-count d-flex align-items-end">
                <div className="number">{data.stats.pending}</div>
              </div>
            </div>
          </div>
          ...
          <div className="counter-box">
            <div className="content-box">
              <div className="title-count text-variant-1">Favorites</div>
              <div className="d-flex align-items-end">
                <div className="number">{data.stats.favorites}</div>
              </div>
            </div>
          </div>
          ...
          <div className="counter-box">
            <div className="content-box">
              <div className="title-count text-variant-1">Reviews</div>
              <div className="d-flex align-items-end">
                <div className="number">{data.stats.reviews}</div>
              </div>
            </div>
          </div>
        </div>
                            ...
                            <div className="listing-box">
                              <div className="images">
                                <Image
                                  ...
                                  width={615}
                                  height={405}
                                  src={listing.imageSrc || "/images/home/house-db-1.jpg"}
                                />
                              </div>
                              <div className="content">
                                <div className="title">
  ...
  <ul className="list-action">
    <li>
      <Link href={`/add-property?id=${listing.id}`} className="item">
        Edit
      </Link>
    </li>
  </ul>
                      ...
                      {!loading && data.favorites.length === 0 && (
                        <tr>
                          <td colSpan="3">No favorite properties found.</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
            ...
            <div className="widget-box-2 mess-box">
              ...
              <ul className="list-mess">
                {data.reviews.map((item) => (
                  <li className="mess-item" key={item.id}>
                    <div className="user-box">
                      <div className="avatar">
                        <Image
                          alt="avt"
                          width={51}
                          height={51}
                          src={item.reviewer_avatar_url || "/images/avatar/avt-png13.png"}
                        />
                      </div>
                      <div className="content">
                        <div className="name fw-6">{item.reviewer_name}</div>
                        <span className="caption-2 text-variant-3">
